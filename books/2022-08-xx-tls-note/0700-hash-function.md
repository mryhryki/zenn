...
次に、上記の文章の最後に改行コード（ASCIIコード値: `10`）を追加すると以下のような出力が得られる。
...
解説は、Wikipedia にかかれている説明だけで十分わかりやすかったので、Wikipedia の内容を引用する。
...
[RFC 2104](https://datatracker.ietf.org/doc/html/rfc2104) として公開されている。
