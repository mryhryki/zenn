import { SourceMemoDir, SourceScrapDir, SourceSlideDir, SourceArticlesDir } from "../definition";
...
export const listAllPosts = async (): Promise<Post[]> => {
  const InputDirPaths: string[] = [SourceArticlesDir, SourceMemoDir, SourceScrapDir, SourceSlideDir];
