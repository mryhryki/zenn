...
https://github.com/hyiromori/example-aws-api-gateway-websocket
...
そして [serverless.yml](https://github.com/hyiromori/example-aws-api-gateway-websocket/blob/main/serverless.yml#L24-L38) で `WebSocket API` のイベントと `Lambda` を紐付けています。
...
[README](https://github.com/hyiromori/example-aws-api-gateway-websocket/blob/main/README.md) に従って実行すると、WebSocket API をデプロイできます。
