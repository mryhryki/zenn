...
私個人の感想としては、Third-Party Cookie 廃止に一歩近づいたのではないかな、と思う提案の内容でした。
まだ提案された段階で、課題も出てくるとは思いますが、FLoC に比べると良さそうに見えます。

私は広告が好きではないですが、[コインハイブ事件の判決](https://www.courts.go.jp/app/files/hanrei_jp/869/090869_hanrei.pdf) にも「ウェブサイトの運営者が閲覧を通じて利益を得る仕組みは，ウェブサイトによる情報の流通にとって重要である」とあるように、Web が広告によって支えられている面もあると思います。
...
本当にこの発言の通りで、FLoC に対しては多くの批判を含むフィードバックがあったようですが、それを受けて改善して来ているので、健全なプロセスが動いているなぁ、と私は感じました。
